...
proc create_ipi_design { offsetfile design_name } {
	...
	# Connect all clock & reset of mmCSR_AXI4_slave_0 slave interfaces..
	connect_bd_intf_net [get_bd_intf_pins axi_peri_interconnect/M00_AXI] [get_bd_intf_pins mmCSR_AXI4_slave_0/mmCSR_AXI4_s]
	connect_bd_net [get_bd_pins mmCSR_AXI4_slave_0/mmcsr_axi4_s_aclk] [get_bd_pins sys_clk_0/clk_out1]
	connect_bd_net [get_bd_pins mmCSR_AXI4_slave_0/mmcsr_axi4_s_aresetn] [get_bd_pins sys_reset_0/peripheral_aresetn]


	# Auto assign address
	assign_bd_address

	# Copy all address to mmCSR_AXI4_slave_v1_0_include.tcl file
	set bd_path [get_property DIRECTORY [current_project]]/[current_project].srcs/[current_fileset]/bd
	upvar 1 $offsetfile offset_file
	set offset_file "${bd_path}/mmCSR_AXI4_slave_v1_0_include.tcl"
	set fp [open $offset_file "w"]
	puts $fp "# Configuration address parameters"

	set offset [get_property OFFSET [get_bd_addr_segs /jtag_axi_0/Data/SEG_mmCSR_AXI4_slave_0_mmCSR_AXI4_s_* ]]
	puts $fp "set mmcsr_axi4_s_addr ${offset}"
...
set hw_test_file ${ip_path}/example_designs/debug_hw_design/mmCSR_AXI4_slave_v1_0_hw_test.tcl
...
for { set i 1 } { 1 } { incr i } {
	set design_name "mmCSR_AXI4_slave_v1_0_hw_${i}"
